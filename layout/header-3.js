                    ...
                    <div className="container clearfix">
                        ...
                        <div className="extra-nav">
                            <div className="extra-cell">
                                <Link href="coming-soon"><a className="btn btn-corner gradient btn-primary"><i className="fa fa-angle-right m-r10"></i>Book a Free Class</a></Link>
                            </div>
                        </div>
                        <div className={`header-nav navbar-collapse collapse justify-content-end ${show ? "show" : ""}`} id="navbarNavDropdown">
                          ...
                          <li className={`${open === "services" ? "open" : ""}`}><a onClick={() => setOpen("services")}><span>Courses</span><i className="fa fa-chevron-down"></i></a>
                                <ul className="sub-menu">					
										...
										<li><Link href="/courseDetails"><a>Course Details</a></Link></li>
                                    <li><Link href="/"><a>Course Details</a></Link></li>
                                    </ul>
                                </li>
