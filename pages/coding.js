...
function CourseDetails() {
  return (
    ...
    <div className="page-content bg-white">
		{/* <!-- Banner  --> */}
		<div className="dlab-bnr-inr overlay-primary-dark" style={{"backgroundImage":"url(images/courses/coding.jpg)"}}>
				...
				<div className="dlab-bnr-inr-entry">
					...
					<nav aria-label="breadcrumb" className="breadcrumb-row">
						<ul className="breadcrumb">
							...
							<li className="breadcrumb-item active" aria-current="page">Coding</li>
						</ul>
					</nav>
					{/* <!-- Breadcrumb Row End --> */}
				</div>
				...
				<div className="row">
						...
						<aside className="side-bar sticky-top">
                            <div className="widget_nav_menu m-b40">
								<ul>
									...
									<li className="active"><Link href="coding"><a>Coding (Web)</a></Link> </li>
					...
					<div className="col-xl-9 col-lg-8">
						<div className="dlab-media m-b30 rounded-md">
							<img src="images/courses/coding.jpg" alt="coding"/>
						</div>
						<div className="dlab-content">
							...
							<div className="row">
								<div className="col-lg-12">
									<h3>How to make your first Website?</h3>
									<p>Edurific's Scientific Curriculum will let your kids to learn real programming concepts through text based coding.</p>
									<ul className="list-check style-1 primary">
										...
										<li>Enroll yourself for a Coding course of your choice</li>
										<li>Learn with fun and make your first website</li>
										<li>Make it live with our Free-Hosting on internet and become a Web-Developer and earn the Certificate</li>
