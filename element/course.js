      ...
      >
        <div className="container">
          <div className="section-head style-1 text-center">
            ...
            <h2 className="title">Introducing Our Futuristic-Tech Courses</h2>
          </div>
          <div className="row">
            <div
            ...
            >
              ...
              >
               ...
               <Link href="artificial-intelligence"><a className="icon-cell"><i className="flaticon-office"></i></a></Link>
                </div>
            ...
            >
              ...
              >
                <div className="icon-bx-md radius bg-red shadow-red">
                  <Link href="coding"><a className="icon-cell"><i className="flaticon-website"></i></a></Link>
                </div>
                <div className="icon-content">
            ...
            >
              ...
              >
                ...
                <Link href="robotics"><a className="icon-cell"><i className="flaticon-pie-charts"></i></a></Link>
                </div>
                <div className="icon-content">
