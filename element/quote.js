					...
					<div className="row align-items-center">
						<div className="col-xl-6 col-lg-7 m-b30 wow fadeInLeft" data-wow-duration="2s" data-wow-delay="0.2s">
							<div className="section-head style-1">
								...
								<h2 className="title">We would love to help!</h2>
							</div>
							<form className="dlab-form dzForm" method="POST" action="script/contact.php">
								...
								<div className="row">
									...
									<div className="col-sm-6">
										<div className="input-group">
											...
											<select name="dzOther[choose_service]" className="form-control" required>
												...
												<option value="3">Class-Reactivation</option>
											</select>
										</div>
									</div>
									...
									<div className="col-sm-12 mt-2">
										...
										<button className="btn btn-link d-inline-flex align-items-center" disabled><i className="fa fa-angle-right m-r10" aria-disabled></i>Submit Now</button>
									</div>
								</div>
							</form>
						</div>
